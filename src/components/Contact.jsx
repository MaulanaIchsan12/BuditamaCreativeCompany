  ...
  const contactInfo = [
    {
      ...
      title: "Lokasi Kantor",
      details: [
        "Ruko Perumahan Metland Cileungsi, Blok AA 14 NO. 11A, Cipenjo, Cileungsi, Bogor, Jawa Barat.",
      ],
    ...
    },
    {
      ...
      title: "Detail Kontak",
      details: [
        "No. Telepon: 0819-9769-0650",
        "Email: Priatamaindiansyah@gmail.com",
      ],
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl p-6 sm:p-8 h-full flex flex-col justify-between">
            ...
            <p className="text-slate-600 mb-4">
              Mari diskusikan bagaimana kami dapat membantu mentransformasi
              bisnis Anda
            </p>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-600 mt-4">
                  Jika Anda memiliki pertanyaan tentang layanan kami,
                  membutuhkan solusi khusus, atau sekadar ingin menyapa, kami
